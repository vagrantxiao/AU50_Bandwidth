...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((real_start == 1'b0) | (output2_c_full_n == 1'b0) | (output1_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((real_start == 1'b0) | (output2_c_full_n == 1'b0) | (output1_c_full_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if ((~((real_start == 1'b0) | (output2_c_full_n == 1'b0) | (output1_c_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (output2_c_full_n == 1'b0) | (output1_c_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_ext_blocking_n = (1'b1 & 1'b1);

assign ap_int_blocking_cur_n = (output2_c_blk_n & output1_c_blk_n);
